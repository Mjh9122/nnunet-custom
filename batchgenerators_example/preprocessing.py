import numpy as np
from config import brats_preprocessed_folder, brats_folder_with_downloaded_train_data, num_threads_for_brats_example
...
if __name__ == "__main__":
    ...
    p.starmap(load_and_preprocess, zip(image_names, [brats_preprocessed_folder] * len(image_names)))
    p.close()
    p.join()
