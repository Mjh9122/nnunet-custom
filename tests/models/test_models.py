...
@pytest.mark.parametrize(
    ...
    (
        ...
        ((2, 1, 128, 128, 128), [1, 32, 64, 128, 256, 256, 256], [5, 5, 5], 3, (2, 3, 128, 128, 128)),
        ((2, 1, 80, 192, 128), [1, 32, 64, 128, 256, 256, 256], [4, 5, 5], 3, (2, 3, 80, 192, 128)),
        ((9, 1, 40, 56, 40), [1, 32, 64, 128, 256], [3, 3, 3], 3, (9, 3, 40, 56, 40)),
        ((2, 1, 112, 128, 128), [1, 32, 64, 128, 256, 256, 256], [4, 5, 5], 3, (2, 3, 112, 128, 128)),
        ((2, 1, 96, 160, 128), [1, 32, 64, 128, 256, 256, 256], [4, 5, 5], 3, (2, 3, 96, 160, 128)),
    ),
)
def test_Unet3D(
    input_shape,
